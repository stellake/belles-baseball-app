...
export const VideoOverlay = ({ questionStatus, hasSelectedCorrectAnswer, isLastVideo, nextExerciseButtonClicked }) => {
  switch (questionStatus) {
    case QUESTION_STATUS.TIMEOUT:
      return <TimeoutOverlay nextExerciseButtonClicked={nextExerciseButtonClicked} />;
